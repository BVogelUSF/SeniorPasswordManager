...
class ManagerApp:
    def __init__(self, master=None):
        ...
        self.genBackButton = tk.Button(self.genFrame, command=lambda: self.homeFrame.tkraise())
    ...
    def login(self):
        ...
        if self.userID == "Username doesn't exist":
    ...
    def createAccount(self):
        ...
        if self.userID == 'Username already exists':
            ...
            messagebox.showinfo('Account not created!', "Account created! Please close this box and press Login.")
    ...
    def clearStoredInfo(self):
        ...
        self.storeNoPWMatchLabel.destroy()
        self.storeFailLabel.destroy()
        self.storeSuccessLabel.destroy()
